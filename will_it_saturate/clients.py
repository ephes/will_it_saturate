# AUTOGENERATED! DO NOT EDIT! File to edit: 40_clients.ipynb (unless otherwise specified).

__all__ = ['register_client', 'get_client_from_registry', 'CLIENT_CLASS_REGISTRY', 'BaseClient', 'ClientParameters',
           'HttpxClient', 'counter', 'request', 'AioHttpResponse', 'AioHttpClient', 'WrkClient', 'counter', 'request']
